...
export const CREATIVE_TOOL_POLICIES: ToolPolicySpec[] = [
  ...
  {
    name: 'write_poem', domain: 'poems', level: 'yellow', allowedSources: ALL_SAFE_SOURCES,
  ...
  {
    name: 'update_intimacy_wheel', domain: 'intimacy-wheel', level: 'yellow', allowedSources: ALL_SAFE_SOURCES,
  ...
  {
    name: 'write_story', domain: 'stories', level: 'yellow', allowedSources: ALL_SAFE_SOURCES,
    resolveLevel: input => input.action === 'delete' ? 'red' : 'yellow',
  },
