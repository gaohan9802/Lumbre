...
export const JOURNAL_TOOL_POLICIES: ToolPolicySpec[] = [
  ...
  { name: 'update_diary', domain: 'diary', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'delete_diary', domain: 'diary', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '删除日记' },
  { name: 'unlock_diary', domain: 'diary', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'set_password', domain: 'diary', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '修改日记密码' },
  ...
  { name: 'edit_foto', domain: 'photos', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'delete_foto', domain: 'photos', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '删除照片' },
