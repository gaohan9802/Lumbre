...
export const LIFE_TOOL_POLICIES: ToolPolicySpec[] = [
  { name: 'write_timeline_encouragements', domain: 'timeline', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'read_timeline_encouragements', domain: 'timeline', level: 'green', allowedSources: ALL_SAFE_SOURCES },
  { name: 'edit_timeline_encouragement', domain: 'timeline', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'delete_timeline_encouragement', domain: 'timeline', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '删除鼓励话' },
  ...
  { name: 'add_todo', domain: 'todo', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'edit_todo', domain: 'todo', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'remove_todo', domain: 'todo', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '删除待办' },
  ...
  { name: 'write_wish', domain: 'wishes', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'edit_wish', domain: 'wishes', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'delete_wish', domain: 'wishes', level: 'red', allowedSources: ALL_SAFE_SOURCES, confirmationLabel: '删除愿望' },
  { name: 'like_wish', domain: 'wishes', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  ...
  { name: 'edit_bookmark', domain: 'bookmarks', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },

  { name: 'read_coupons', domain: 'coupons', level: 'green', allowedSources: ALL_SAFE_SOURCES },
  { name: 'create_coupon', domain: 'coupons', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'sign_coupon', domain: 'coupons', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
  { name: 'edit_coupon', domain: 'coupons', level: 'yellow', allowedSources: ALL_SAFE_SOURCES },
