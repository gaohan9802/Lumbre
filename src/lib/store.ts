...
type Tab = 'chat' | 'trio' | 'diary' | 'notes' | 'todo' | 'photos' | 'memory' | 'coreading' | 'dreams' | 'tesis' | 'wishlist'

const VALID_TABS: Tab[] = ['chat', 'trio', 'diary', 'notes', 'todo', 'photos', 'memory', 'coreading', 'dreams', 'tesis', 'wishlist']
