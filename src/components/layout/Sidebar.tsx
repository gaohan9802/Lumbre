...
const tabs = [
  ...
  { id: 'poems' as const, label: '共诗', image: '/directory/poems.svg' },
  { id: 'stories' as const, label: '枕边集', image: '/directory/stories.svg' },
  { id: 'research' as const, label: '星野手记', image: '/directory/research.svg' },
